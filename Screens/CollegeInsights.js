...
const CollegeInsights = ({navigation}) => {
...
<SafeAreaView style={styles.container}>
  ...
  <View style={styles.content}>
    ...
    <Image
      source={require('../Assets/images/college-insight.png')}
      style={{ width: '100%',height: 300, resizeMode: 'contain'}}
    />

    <Text style={styles.title}>Collage insights</Text>
  ...
  <View style={styles.bottomWrapper}>
    <View style={styles.bottomNav}>
      <TouchableOpacity onPress={() => navigation.navigate('FormFillingGuidence')}>
        <Text style={styles.bottomText}>Skip</Text>
      </TouchableOpacity>

      <TouchableOpacity
        onPress={() => navigation.navigate('ReminderandSupport')}>
